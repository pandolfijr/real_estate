...
class RenterController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if ($request->id_people) {
            ...
            $request->validate([
                ...
                'income' => 'required|numeric|min:0',
                'people.cpf' => 'required|string|max:11|unique:people',
                'people.rg' => 'required|string|max:11|unique:people',
    ...
    public function update(Request $request, string $id_renter)
    {
        ...
        $request->validate([
            ...
            'people.surname' => 'required|string|max:70',
            'income' => 'required|numeric|min:0',
            'people.cpf' => 'required|string|max:11|unique:people,cpf,' .  $input['people']['id'],
            'people.rg' => 'required|string|max:11|unique:people,rg,' .  $input['people']['id'],
