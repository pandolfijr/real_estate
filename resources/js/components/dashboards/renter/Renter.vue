<template>
    <div class="container-fluid">
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="name"
                                    :disabled="renter.people_exists" placeholder="Informe o Nome" maxlength="20"
                                    value="" v-model="renter.people.name" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputSurname"
                                    ...
                                    :disabled="renter.people_exists" v-model="renter.people.surname" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="inputBirthDate"
                                    ...
                                    :disabled="renter.people_exists" v-model="renter.people.birth_date" />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="inputMaritalStatus" name="marital_status"
                                    :disabled="renter.people_exists" v-model="renter.people.marital_status">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control cnpj" id="inputCnpj" name="cnpj"
                                    v-model="renter.people.cnpj" placeholder="Informe o CNPJ"
                                    v-mask="'##.###.###/####-##'" :disabled="renter.people_exists"
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control cpf" id="inputCpf" name="cpf"
                                    :disabled="renter.people_exists" @blur="getPeopleByCpf($event)"
                                    v-model="renter.people.cpf" placeholder="Informe o CPF" v-mask="'###.###.###-##'"
                                    masked="false" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <input v-else class="form-label" type="file" id="cpf_proof" name="cpf_proof"
                                :disabled="renter.people_exists" @change="handleFileUpload($event, 'cpf')" />
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="inputRg">RG</label>
                                <input type="text" class="form-control cpf" id="inputRg" name="rg" maxlength="11"
                                    :disabled="renter.people_exists" v-model="renter.people.rg"
                                    placeholder="Informe o RG" @keypress="isNumber($event)" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <input v-else class="form-label" type="file" id="rg_proof" name="rg_proof"
                                :disabled="renter.people_exists" @change="handleFileUpload($event, 'rg')" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputCellphone" name="cellphone"
                                    :disabled="renter.people_exists" v-model="renter.people.cellphone"
                                    placeholder="Informe o Celular" v-mask="['(##) ####-####', '(##) #####-####']"
                                    masked="false" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputEmail" maxlength="40"
                                    :disabled="renter.people_exists" v-model="renter.people.email" name="email"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputAddress"
                                    :disabled="renter.people_exists" v-model="renter.people.address"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputNumber" v-model="renter.people.number"
                                    :disabled="renter.people_exists" placeholder="No." name="number" maxlength="11"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputDistrict"
                                    :disabled="renter.people_exists" v-model="renter.people.district"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputComplement"
                                    :disabled="renter.people_exists" v-model="renter.people.complement"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="inputIdCity" name="id_city"
                                    :disabled="renter.people_exists" v-model="renter.people.id_city">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control cep" id="cep" placeholder="Digite o CEP"
                                    :disabled="renter.people_exists" v-mask="'#####-###'" masked="false" name="cep"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputProfession" maxlength="40"
                                    v-model="renter.people.profession" name="profession"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <money3 class="form-control" v-model="renter.income" v-bind="config"
                    ...
                    <div class="modal-footer justify-content-center">
                        <button v-if="renter.id" type="submit" class="btn btn-primary" @click="updateRenter()">
                            Atualizar
                        </button>
            ...
            <div v-if="renter.transaction && renter.transaction.length >= 1" class="card card-primary">
                <div class="card-header">
                        ...
                        <table class="table table-head-fixed text-nowrap text-left">
                            ...
                            <tbody>
                                <tr v-for="transaction in renter.transaction" :key="transaction.id">
                                    ...
                                    <td>
                                        <router-link :to="'/renter/' + transaction.id_renter + '/edit'"
                                    ...
                                    <td>
                                        <router-link :to="'/property/' + transaction.id + '/edit'"
                                            class="small-box-footer">
                                            <button type="button" class="btn btn-outline-primary"
                                                style="margin-top: -0.5em">
                                                <i class="fas fa-solid fa-eye"></i>
            ...
            <div v-if="transactions.length > 0 && accounts.length > 0" class="card card-primary">
                <div class="card-header">
        ...
        handlesSpecialCharacters() {
            ...
            this.renter.people.cep =
                this.renter.people.cep != null
                    ...
                    : "";
            this.renter.people.cnpj =
                this.renter.people.cnpj != null
                    ? this.renter.people.cnpj.replace(/[.\/-\s()]/g, "")
                    : "";
        },
