            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputName"
                  name="name"
                  :disabled="guarantor.people_exists"
                  placeholder="Informe o Nome"
                  maxlength="20"
                  value=""
                  v-model="guarantor.people.name"
                />
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  name="surname"
                  maxlength="70"
                  v-model="guarantor.people.surname"
                />
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  name="birth_date"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.birth_date"
                />
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select
                  ...
                  name="marital_status"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.marital_status"
                >
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputCellphone"
                  name="cellphone"
                  v-model="guarantor.people.cellphone"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  maxlength="40"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.email"
                  name="email"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputAddress"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.address"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputNumber"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.number"
                  placeholder="No."
                  name="number"
                  maxlength="11"
                  @keypress="isNumber($event)"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputDistrict"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.district"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputComplement"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.complement"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <select
                  ...
                  name="id_city"
                  :disabled="guarantor.people_exists"
                  v-model="guarantor.people.id_city"
                >
          ...
          <div class="row">
            <div class="col-sm-6">
              <label class="form-label" for="customFile"
                >Comprovante de Registro de Imóvel</label
              ><br />
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputProfession"
                  maxlength="40"
                  v-model="guarantor.people.profession"
                  name="profession"
