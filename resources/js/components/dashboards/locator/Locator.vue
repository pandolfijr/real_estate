<template>
  <div class="container-fluid">
    <div class="col-md-12">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  maxlength="70"
                  :disabled="locator.people_exists"
                  v-model="locator.people.surname"
                />
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  name="birth_date"
                  :disabled="locator.people_exists"
                  v-model="locator.people.birth_date"
                />
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select
                  ...
                  name="marital_status"
                  :disabled="locator.people_exists"
                  v-model="locator.people.marital_status"
                >
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label for="inputRg">RG<b>*</b></label>
                <input
                  type="text"
                  class="form-control cpf"
                  id="inputRg"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputCellphone"
                  name="cellphone"
                  v-model="locator.people.cellphone"
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  id="inputAddress"
                  v-model="locator.people.address"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  id="inputDistrict"
                  v-model="locator.people.district"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  id="inputComplement"
                  v-model="locator.people.complement"
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <select
                  ...
                  name="id_city"
                  :disabled="locator.people_exists"
                  v-model="locator.people.id_city"
                >
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input
                  ...
                  id="inputProfession"
                  maxlength="40"
                  v-model="locator.people.profession"
                  name="profession"
      ...
      <div
        v-if="locator.property && locator.property.length >= 1"
              ...
              <tbody>
                <tr v-for="property in locator.property" :key="property.id">
                  ...
                  <td v-if="property.id_transaction">
                    <router-link
                      :to="'/transaction/' + property.id_transaction + '/edit'"
                      class="small-box-footer"
                    >
                      <button
                        type="button"
