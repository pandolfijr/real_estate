                                    ...
                                    <div class="row" style="margin: 2em;">
                                        <div class="col-md-2 col-search">
                                            <input type="text" class="form-control" name="descricao"
                                                ...
                                                aria-label="Código ou Descrição" value="{{ $filtro['descricao'] ?? ''}}">
                                        </div>
                                        ...
                                        <div class="col-md-1 col-search">
                                            <select name="tipo" id="inputTipo" class="form-select" value="{{ $filtro['tipo'] ?? ''}}">>
                                        ...
                                        <div class="col-md-1 col-search">
                                            <select name="cidade" id="inputCidade" class="form-select" value="{{ $filtro['cidade'] ?? ''}}">>
                                                <option value="">Cidade... {{($filtro['cidade'] ?? '')}}</option>
                                                @foreach ($cidades as $cidade)
                                                    <option value="{{ $cidade->id }}" {{ $cidade->id  == ($filtro['cidade'] ?? '') ? 'selected' : '' }}>
                                                        {{ $cidade->nome }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-1 col-search">
                                            <select name="dormitorios" id="inputQuartos" class="form-select" value="{{ $filtro['dormitorios'] ?? ''}}">>
                                        ...
                                        <div class="col-md-1 col-search">
                                            <select name="ordenar" id="inputBanheiros" class="form-select" value="{{$filtro['ordenar'] ?? ''}}">
                                                <option value="" >Ordenar Valor</option>
                                                <option value="desc" {{ 'desc'  == ($filtro['ordenar'] ?? '') ? 'selected' : '' }} >Decrescente</option>
                                                <option value="asc" {{ 'asc'  == ($filtro['ordenar'] ?? '') ? 'selected' : '' }}>Crescente</option>
                                            </select>
                                        </div>
