...
<body>
    <div class="container" style="margin-top: 3em;">
        ...
        <div class="info-section">
            ...
            <div class="row">
                <div class="col-12">Declaramos para os devidos fins de direito e efeitos legais que recebemos do
                    Locatário acima conforme procuração
                    outorgada a Imobiliaria da Renata - CRECI 136.300 a(s) importância(s) abaixo que se refere(m) ao
                    contrato de Locação, ao
                    Período e ao ano mencionado, não dando quitação de verbas e meses anteriores, que serão comprovados
                    os pagamentos
                    com recibos específicos. As numerações são oriundas de nossos arquivos.</div>
            </div>
        </div>
        ...
        <div class="values-section">
            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <b>R$
                        {{ number_format($installment->installment_total_value ?? '0.00', 2, '.', '') }}
                    </b>
                </div>
            </div>
